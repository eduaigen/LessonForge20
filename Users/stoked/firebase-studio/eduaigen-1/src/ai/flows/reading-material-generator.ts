...
1.  **Source Material**: Your ONLY source of information is the provided JSON lesson plan. Do not invent new content, topics, or data.
...
**Part 2: Extract Diagram Description**
* If 'miniLesson.diagram' exists in the lesson plan, copy its exact text description into the 'keyDiagram' field of your response. If it doesn't exist, omit the 'keyDiagram' field.

**Part 3: Generate the Initial Question Cluster**
