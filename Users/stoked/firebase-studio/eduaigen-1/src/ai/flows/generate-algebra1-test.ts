...
1.  **Use LaTeX for ALL math**: Every mathematical expression, variable, number, and equation MUST be wrapped in double dollar signs, like $$x^2 + 2x - 1$$. Do NOT escape backslashes (e.g., use $$\\frac{1}{2}$$, not $$\\frac{1}{2}$$).
