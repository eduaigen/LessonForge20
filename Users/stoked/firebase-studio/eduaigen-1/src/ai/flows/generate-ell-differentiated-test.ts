...
export async function generateDifferentiatedELLTest(input: z.infer<typeof DifferentiatedELLTestInputSchema>): Promise<z.infer<typeof GenerateELLTestOutputSchema>> {
