...
const headerSchema = z.object({
    ...
    unitTitle: z.string(),
    name: z.string().describe("A placeholder string for the student's name, e.g., 'Name: ____________________________'"),
    date: z.string().describe("A placeholder string for the date, e.g., 'Date: _________________'"),
    class: z.string().describe("A placeholder string for the class, e.g., 'Class: _____________________________'"),
    period: z.string().describe("A placeholder string for the period, e.g., 'Period: _________'"),
});
