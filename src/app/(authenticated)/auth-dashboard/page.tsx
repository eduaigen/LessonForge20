...
const tools = {
    science: [
       {
        ...
        href: '/auth-dashboard/lesson-plan-generator?subject=NV%20Biology',
        isPremium: true,
        priceId: 'price_1Pg0yPAk4y2zY5d6o4qZ5aBc',
      },
       {
        title: 'NV Biology Lab Generator',
        description: 'Create labs for the NV Biology curriculum.',
      ...
      },
      {
        ...
        href: '/auth-dashboard/lesson-plan-generator?subject=NGSS%20Biology%20(OpenSciEd)',
        isPremium: true,
        priceId: 'price_1Pg0yqAk4y2zY5d6n7s8tUvW',
      },
       {
        title: 'NGSS Biology Lab Generator',
        description: 'Create labs for the NGSS Biology curriculum.',
        icon: <TestTube className="w-8 h-8" />,
        href: '/auth-dashboard/ngss-biology-lab-generator',
        isPremium: true,
        priceId: 'price_1Pg0yqAk4y2zY5d6n7s8tUvW',
      },
      {
        ...
        icon: <Dna className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=AP%20Biology',
        isPremium: true,
        priceId: 'price_1Pg13AAk4y2zY5d6jKlMnOpQ',
      },
      {
        title: 'AP Biology Lab Generator',
        description: 'Create labs for the AP Biology curriculum.',
        icon: <TestTube className="w-8 h-8" />,
        href: '/auth-dashboard/ap-biology-lab-generator',
        isPremium: true,
        priceId: 'price_1Pg13AAk4y2zY5d6jKlMnOpQ',
      },
      {
        title: 'Chemistry (OpenSciEd)',
        description: 'Foundational chemical principles.',
        icon: <Atom className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=Chemistry%20(OpenSciEd)',
        isPremium: true,
        priceId: 'price_1Pg0zFAk4y2zY5d6xYz0a1bC',
      },
      {
        title: 'Chemistry Lab Generator',
        description: 'Create labs for the Chemistry curriculum.',
        icon: <TestTube className="w-8 h-8" />,
        href: '/auth-dashboard/chemistry-lab-generator',
        isPremium: true,
        priceId: 'price_1Pg0zFAk4y2zY5d6xYz0a1bC',
      },
      {
        title: 'Physics (OpenSciEd)',
        description: 'Core concepts like motion, forces, energy.',
        icon: <Magnet className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=Physics%20(OpenSciEd)',
        isPremium: true,
        priceId: 'price_1Pg0znAk4y2zY5d6pQrStVwX',
      },
       {
        title: 'Physics Lab Generator',
        description: 'Create labs for the Physics curriculum.',
        icon: <TestTube className="w-8 h-8" />,
        href: '/auth-dashboard/physics-lab-generator',
        isPremium: true,
        priceId: 'price_1Pg0znAk4y2zY5d6pQrStVwX',
      },
       {
        title: 'NV Earth Science',
        description: 'NYS Physical Setting curriculum.',
        icon: <Orbit className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=NV%20Earth%20Science',
        isPremium: true,
        priceId: 'price_1Pg10AAk4y2zY5d6LMN9oPqR',
      },
      {
        title: 'NV Earth Science Lab Generator',
        description: 'Create labs for the NV Earth Science curriculum.',
        icon: <TestTube className="w-8 h-8" />,
        href: '/auth-dashboard/earth-science-lab-generator',
        isPremium: true,
        priceId: 'price_1Pg10AAk4y2zY5d6LMN9oPqR',
      },
       {
    ...
    math: [
        ...
        href: '/auth-dashboard/lesson-plan-generator?subject=Illustrative%20Math%20Algebra%201',
        isPremium: true,
      ...
      },
      {
        ...
        icon: <Sigma className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=Illustrative%20Math%20Algebra%202',
        isPremium: true,
      ...
      },
       {
        ...
        icon: <Sigma className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=Illustrative%20Math%20Geometry',
        isPremium: true,
    ...
    ela: [
        ...
        href: '/auth-dashboard/lesson-plan-generator?subject=ELA%209th%20Grade',
        isPremium: true,
      ...
      },
       {
        ...
        icon: <Library className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=ELA%2010th%20Grade',
        isPremium: true,
      ...
      },
       {
        ...
        icon: <Library className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=ELA%2011th%20Grade',
        isPremium: true,
      ...
      },
       {
        ...
        icon: <Library className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=ELA%2012th%20Grade',
        isPremium: true,
    ...
    social: [
      ...
      },
      {
      ...
      },
       {
        ...
        icon: <History className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=US%20History%20&%20Government',
        isPremium: true,
      ...
      },
       {
        ...
        icon: <History className="w-8 h-8" />,
        href: '/auth-dashboard/lesson-plan-generator?subject=Government%20&%20Economics',
        isPremium: true,
