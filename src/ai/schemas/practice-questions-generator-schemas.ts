...
const questionSchema = z.object({
    ...
    options: z.array(z.string()).optional().describe("An array of four answer choices for multiple-choice questions."),
...
export const GeneratePracticeQuestionsOutputSchema = z.object({
  ...
  questions: z.array(questionSchema).min(5).max(7).describe('A list of 5-7 varied practice questions with answers and explanations.'),
});
