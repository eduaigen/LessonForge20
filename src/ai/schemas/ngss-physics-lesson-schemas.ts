...
export const GenerateNGSSPhysicsLessonInputSchema = z.object({
  unit: z.string().describe('The unit from the NGSS Physics curriculum.'),
...
export const GenerateNGSSPhysicsLessonOutputSchema = z.object({
...
export type GenerateNGSSPhysicsLessonInput = z.infer<typeof GenerateNGSSPhysicsLessonInputSchema>;
export type GenerateNGSSPhysicsLessonOutput = z.infer<typeof GenerateNGSSPhysicsLessonOutputSchema>;
