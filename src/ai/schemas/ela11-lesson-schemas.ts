...
export const GenerateELA11LessonInputSchema = z.object({
  unit: z.string().describe('The unit from the ELA 11 curriculum.'),
...
const lessonOverviewSchema = z.object({
  ...
  standards: z.string().describe("Relevant ELA Standard (e.g., CCSS.ELA-LITERACY.RL.11-12.2)"),
...
export const GenerateELA11LessonOutputSchema = z.object({
...
export type GenerateELA11LessonInput = z.infer<typeof GenerateELA11LessonInputSchema>;
export type GenerateELA11LessonOutput = z.infer<typeof GenerateELA11LessonOutputSchema>;
