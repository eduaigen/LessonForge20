...
export const GenerateELA10LessonInputSchema = z.object({
  unit: z.string().describe('The unit from the ELA 10 curriculum.'),
...
export const GenerateELA10LessonOutputSchema = z.object({
...
export type GenerateELA10LessonInput = z.infer<typeof GenerateELA10LessonInputSchema>;
export type GenerateELA10LessonOutput = z.infer<typeof GenerateELA10LessonOutputSchema>;
