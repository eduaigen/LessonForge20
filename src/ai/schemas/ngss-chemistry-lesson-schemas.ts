...
export const GenerateNGSSChemistryLessonInputSchema = z.object({
  unit: z.string().describe('The unit from the NGSS Chemistry curriculum.'),
...
const lessonOverviewSchema = z.object({
  ...
  standards: z.string().describe("NGSS Standards"),
...
export const GenerateNGSSChemistryLessonOutputSchema = z.object({
...
export type GenerateNGSSChemistryLessonInput = z.infer<typeof GenerateNGSSChemistryLessonInputSchema>;
export type GenerateNGSSChemistryLessonOutput = z.infer<typeof GenerateNGSSChemistryLessonOutputSchema>;
