...
export const GenerateAlgebra1LessonInputSchema = z.object({
  unit: z.string().describe('The unit from the Illustrative Math Algebra 1 curriculum.'),
...
const lessonOverviewSchema = z.object({
  ...
  standards: z.string().describe("Relevant Math Standard (e.g., HSA.CED.A.1)"),
...
export const GenerateAlgebra1LessonOutputSchema = z.object({
...
export type GenerateAlgebra1LessonInput = z.infer<typeof GenerateAlgebra1LessonInputSchema>;
export type GenerateAlgebra1LessonOutput = z.infer<typeof GenerateAlgebra1LessonOutputSchema>;
