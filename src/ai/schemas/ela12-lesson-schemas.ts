...
export const GenerateELA12LessonInputSchema = z.object({
  unit: z.string().describe('The unit from the ELA 12 curriculum.'),
...
export const GenerateELA12LessonOutputSchema = z.object({
...
export type GenerateELA12LessonInput = z.infer<typeof GenerateELA12LessonInputSchema>;
export type GenerateELA12LessonOutput = z.infer<typeof GenerateELA12LessonOutputSchema>;
