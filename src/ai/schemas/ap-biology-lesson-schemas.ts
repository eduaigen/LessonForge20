...
export const GenerateAPBiologyLessonInputSchema = z.object({
  unit: z.string().describe('The unit from the AP Biology curriculum.'),
...
const lessonOverviewSchema = z.object({
  ...
  standards: z.string().describe("AP Biology Standards"),
...
export const GenerateAPBiologyLessonOutputSchema = z.object({
...
export type GenerateAPBiologyLessonInput = z.infer<typeof GenerateAPBiologyLessonInputSchema>;
export type GenerateAPBiologyLessonOutput = z.infer<typeof GenerateAPBiologyLessonOutputSchema>;
