...
3.  **Vary Question Types:** The questions should be a mix of the following types, appropriate for the specified subject:
    *   **Multiple-Choice:** Create at least two multiple-choice questions. Each must have four plausible answer choices.
    ...
    *   **Math Specifics:** If the subject is Math, ensure questions use LaTeX for all expressions and may require calculations or explanations of a process.
...
4.  **Provide a Detailed Answer Key:** For each question, provide a correct answer and a brief (1-2 sentence) explanation of why it is correct. For multiple-choice questions, the answer should be the full text of the correct option.
`,
});
