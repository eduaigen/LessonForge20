...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert high school U.S. History teacher and assessment writer for the NYS U.S. History & Government curriculum. Your task is to generate a comprehensive, multi-part test based on specific curriculum units.
