            ...
            topics: {
                ...
                "Water Balance 5E": {
                    lessons: [
                        ...
                        { title: "Lesson 31 (Elaborate): Extending conceptual understanding by applying thinking to novel situations.", objective: "Students will test ideas about osmoregulation by investigating if goldfish can live in saltwater aquariums, evaluating models and proposing criteria for a model representing freshwater goldfish stability in saltwater." },
