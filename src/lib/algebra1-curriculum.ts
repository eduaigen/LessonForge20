            ...
            topics: {
                ...
                "Quadratic equations": {
                    ...
                    lessons: [
                        ...
                        { title: "Lesson 6: The Quadratic Formula", objective: "I can solve a quadratic equation in the form $$ax^2 + bx + c = 0$$ using the quadratic formula: $$x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a}$$", standard: "AI-A.REI.4b" }
                    ]
                },
