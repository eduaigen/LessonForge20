            ...
            topics: {
                ...
                "Quadratic equations": {
                    ...
                    lessons: [
                        ...
                        { title: "Lesson 6: The Quadratic Formula", objective: "I can use the quadratic formula to solve a quadratic equation.", standard: "AI-A.REI.4b" }
                    ]
                },
        ...
        "Unit 7: Structures of Quadratic Expressions": {
            ...
            topics: {
                ...
                "Standard form": {
                    topic: "Standard form",
                    lessons: [
                        { title: "Lesson 5: The Quadratic Formula", objective: "I can use the quadratic formula to solve a quadratic equation.", standard: "AI-A.REI.4b" }
                    ]
                }
            }
        },
