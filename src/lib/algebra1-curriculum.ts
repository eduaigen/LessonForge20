        ...
        "Unit 7: Structures of Quadratic Expressions": {
            ...
            topics: {
                ...
                "Standard form": {
                    topic: "Standard form",
                    lessons: [
                        { title: "Lesson 5: The Quadratic Formula", objective: "I can use the quadratic formula $$x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a}$$ to solve a quadratic equation in the form $$ax^2 + bx + c = 0$$.", standard: "AI-A.REI.4b" }
                    ]
                }
            }
        },
