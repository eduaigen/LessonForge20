...
const GeneratorContent = () => {
  ...
  async function onLessonPlanSubmit(values: FormData) {
    ...
    try {
      const result = await generateGlobalHistory1Lesson(values);
              ...
              <Card className="w-full shadow-lg mb-8">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className="text-2xl font-headline">Global History & Geography I</CardTitle>
                      <CardDescription>Create 5E model lesson plans for 9th Grade Global History.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
...
export default function GlobalHistory1Generator() {
