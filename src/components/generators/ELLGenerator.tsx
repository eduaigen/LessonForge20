...
import { Loader2, Languages, Sparkles, Wand2, Check, X } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import { ellCurriculum } from '@/lib/ell-curriculum';
import { generateELLLesson, type GenerateELLLessonOutput } from '@/ai/flows/generate-ell-lesson';
    ...
    <div className="flex flex-1 items-center justify-center">
        <Card className="max-w-2xl text-center p-8 shadow-lg">
            <CardHeader>
                ...
                <CardDescription>
                    The ELL/ENL Lesson Generator requires an ELL curriculum subscription. Subscribe now to create powerful, standards-aligned 5E lesson plans.
                </CardDescription>
            </CardHeader>
            <CardContent>
...
const GeneratorContent = () => {
  ...
  async function onLessonPlanSubmit(values: FormData) {
    ...
    try {
      const result = await generateELLLesson(values);
                  ...
                  <CardHeader>
                      <div className="flex items-center justify-between flex-wrap gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                              <CardTitle className="text-2xl font-headline">ELL/ENL Lesson Generator (Grades 9-12)</CardTitle>
                              <CardDescription>Create scaffolded 5E model lesson plans for English Language Learners.</CardDescription>
                          </div>
                        </div>
                      </div>
                  </CardHeader>
                        ...
                        <Accordion type="single" collapsible className="w-full" defaultValue='item-1'>
                          ...
                          <FormField
                              ...
                              render={({ field }) => (
                                  ...
                                  <FormControl>
                                      <Textarea placeholder="e.g., 'Focus on speaking skills', 'My students are mostly Spanish speakers', 'Include a role-playing activity'" {...field} />
                                  </FormControl>
                                  <FormMessage />
                                  </FormItem>
                              )}
...
export default function ELLGenerator() {
