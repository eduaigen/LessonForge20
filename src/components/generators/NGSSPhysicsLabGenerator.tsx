...
import { generateNGSSPhysicsLab, type GenerateLabActivityOutput } from '@/ai/flows/generate-ngss-physics-lab';
    ...
    <div className="flex flex-1 items-center justify-center">
        <Card className="max-w-2xl text-center p-8 shadow-lg">
            <CardHeader>
                ...
                <CardDescription>
                    The NGSS Physics Lab Generator requires a Science curriculum subscription. Subscribe now to create powerful, 45-minute lab activities.
                </CardDescription>
            </CardHeader>
            <CardContent>
...
const GeneratorContent = () => {
  ...
  async function onSubmit(values: FormData) {
    ...
    try {
      const result = await generateNGSSPhysicsLab({ lessons: values.lessons, additionalInfo: values.additionalInfo });
              ...
              <Card className="w-full shadow-lg mb-8">
                  <CardHeader>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                          <CardTitle className="text-2xl font-headline">NGSS Physics Lab Generator</CardTitle>
                          <CardDescription>Generate a 45-minute, NGSS-aligned lab activity for a physics lesson.</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                      ...
                      render={() => (
                        <FormItem>
                            ...
                            <Accordion type="multiple" className="w-full">
                                {units.map((unitKey) => {
                                    const unit = physicsCurriculum.units[unitKey];
...
export default function NGSSPhysicsLabGenerator() {
