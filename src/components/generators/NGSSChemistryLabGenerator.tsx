...
import { generateNGSSChemistryLab, type GenerateLabActivityOutput } from '@/ai/flows/generate-ngss-chemistry-lab';
    ...
    <div className="flex flex-1 items-center justify-center">
        <Card className="max-w-2xl text-center p-8 shadow-lg">
            <CardHeader>
                ...
                <CardDescription>
                    The NGSS Chemistry Lab Generator requires a Science curriculum subscription. Subscribe now to create powerful, 45-minute lab activities.
                </CardDescription>
            </CardHeader>
            <CardContent>
...
const GeneratorContent = () => {
  ...
  async function onSubmit(values: FormData) {
    ...
    try {
      const result = await generateNGSSChemistryLab({ lessons: values.lessons, additionalInfo: values.additionalInfo });
              ...
              <Card className="w-full shadow-lg mb-8">
                  <CardHeader>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                          <CardTitle className="text-2xl font-headline">NGSS Chemistry Lab Generator</CardTitle>
                          <CardDescription>Generate a 45-minute, NGSS-aligned lab activity for a chemistry lesson.</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-6">
                      ...
                      render={() => (
                        <FormItem>
                            ...
                            <Accordion type="multiple" className="w-full">
                                {units.map((unitKey) => {
                                    const unit = chemistryCurriculum.units[unitKey];
                    ...
                    <FormField control={form.control} name="additionalInfo" render={({ field }) => (
                        ...
                        <FormControl>
                            <Textarea placeholder="e.g., 'Focus on qualitative observations', 'Ensure materials are non-toxic', 'Make it a competitive challenge'" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )} />
...
export default function NGSSChemistryLabGenerator() {
