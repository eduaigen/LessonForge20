...
import { Loader2, Sparkles, Wand2, Landmark } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import { governmentEconomicsCurriculum } from '@/lib/government-economics-curriculum';
import { generateGovernmentTest } from '@/ai/flows/generate-government-test';
...
const GeneratorContent = () => {
  ...
  async function onSubmit(values: FormData) {
    ...
    setTestPackage(null);
    try {
      const result = await generateGovernmentTest(values);
              ...
              <Card className="w-full shadow-lg mb-8">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className="text-2xl font-headline">Government & Economics Test Generator</CardTitle>
                      <CardDescription>Create a custom, Regents-style test for Government & Economics.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
...
export default function GovernmentTestGenerator() {
