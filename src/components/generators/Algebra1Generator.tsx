...
import { Loader2, Sigma, Sparkles, Wand2, Check } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import { algebra1Curriculum } from '@/lib/algebra1-curriculum';
import { generateAlgebra1Lesson, type GenerateAlgebra1LessonOutput } from '@/ai/flows/generate-algebra1-lesson';
    ...
    <div className="flex flex-1 items-center justify-center">
        <Card className="max-w-2xl text-center p-8 shadow-lg">
            <CardHeader>
                ...
                <CardDescription>
                    The Algebra 1 Generator requires a Math curriculum subscription. Subscribe now to create powerful, standards-aligned 5E lesson plans.
                </CardDescription>
            </CardHeader>
            <CardContent>
...
const GeneratorContent = () => {
  ...
  const lessonPlan = useMemo(() => {
    return lessonPackage?.find(item => item.type === 'Lesson Plan')?.content as GenerateAlgebra1LessonOutput | null;
  }, [lessonPackage]);
  ...
  async function onLessonPlanSubmit(values: FormData) {
    ...
    try {
      const result = await generateAlgebra1Lesson(values);
                  ...
                  <CardHeader>
                      <div className="flex items-center justify-between flex-wrap gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                              <CardTitle className="text-2xl font-headline">Illustrative Math - Algebra 1 Lesson Generator</CardTitle>
                        ...
                        <Accordion type="single" collapsible className="w-full" defaultValue='item-1'>
                          ...
                          <FormField
                              ...
                              render={({ field }) => (
                                  ...
                                  <FormControl>
                                      <Textarea placeholder="e.g., 'Focus on visual representations', 'Connect to real-world financial literacy', 'Emphasize collaborative problem-solving'" {...field} />
                                  </FormControl>
                                  <FormMessage />
                                  </FormItem>
                              )}
...
export default function Algebra1Generator() {
