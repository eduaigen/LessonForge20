...
import { generateGlobalHistory1Test } from '@/ai/flows/generate-global-history-1-test';
...
const GeneratorContent = () => {
  ...
  async function onSubmit(values: FormData) {
    ...
    setTestPackage(null);
    try {
      const result = await generateGlobalHistory1Test(values);
              ...
              <Card className="w-full shadow-lg mb-8">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className="text-2xl font-headline">Global History I Test Generator</CardTitle>
                      <CardDescription>Create a custom, Regents-style test for 9th Grade Global History.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="space-y-6">
                    <FormField
                        ...
                        <FormItem>
                            ...
                            {units.map((unitKey) => {
                                const unit = globalHistory1Curriculum.units[unitKey as keyof typeof globalHistory1Curriculum.units];
                                if (!unit) return null;
                                return (
...
export default function GlobalHistory1TestGenerator() {
