                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              render={({ field }) => (
                                  ...
                                  <Select onValueChange={(value) => {
                                      ...
                                      <SelectContent>
                                      {units.map((unitKey) => {
                                        const unit = nvBiologyCurriculum.units[unitKey as keyof typeof nvBiologyCurriculum.units];
                                        return (
                              ...
                              render={({ field }) => (
                                  ...
                                  <Select onValueChange={(value) => {
                                      ...
                                      <SelectContent>
                                      {topics.map((topicKey) => {
                                        const unit = nvBiologyCurriculum.units[selectedUnit as keyof typeof nvBiologyCurriculum.units];
