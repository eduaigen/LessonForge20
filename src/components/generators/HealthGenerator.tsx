...
import { Loader2, HeartPulse, Sparkles, Wand2, Printer, Languages } from 'lucide-react';
    ...
    <div className="flex flex-1 items-center justify-center">
        <Card className="max-w-2xl text-center p-8 shadow-lg">
            <CardHeader>
                ...
                <CardDescription>
                    The Health Lesson Generator requires a Science curriculum subscription. Subscribe now to create powerful, standards-aligned 5E lesson plans.
                </CardDescription>
            </CardHeader>
            <CardContent>
...
const GeneratorContent = () => {
  ...
  const lessonPlan = useMemo(() => {
    return lessonPackage?.find(item => item.type === 'Lesson Plan')?.content as GenerateHealthLessonOutput | null;
  }, [lessonPackage]);
  ...
  async function onLessonPlanSubmit(values: FormData) {
    ...
    try {
      const result = await generateHealthLesson(values);
            ...
            <div className="flex-grow">
              <Card className="w-full shadow-lg mb-8">
                  <CardHeader>
                      ...
                      <div>
                          <CardTitle className="text-2xl font-headline">Health Lesson Generator</CardTitle>
                          <CardDescription>Create 5E model lesson plans aligned with the Health curriculum.</CardDescription>
                      </div>
                      </div>
                  </CardHeader>
                  <Form {...form}>
                      ...
                      <CardContent className="space-y-6">
                          ...
                          <FormField
                              ...
                              render={({ field }) => (
                                  ...
                                  <FormControl>
                                      <Textarea placeholder="e.g., 'Focus on social-emotional learning', 'Include a role-playing activity', 'Adapt for middle school students'" {...field} />
                                  </FormControl>
                                  <FormMessage />
                                  </FormItem>
                              )}
...
export default function HealthGenerator() {
