...
import { generateNVBiologyLab } from '@/ai/flows/generate-nv-biology-lab';
...
const GeneratorContent = () => {
  ...
  async function onSubmit(values: FormData) {
    ...
    try {
      const result = await generateNVBiologyLab({ lessons: values.lessons, additionalInfo: values.additionalInfo });
                    ...
                    <CardHeader>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <CardDescription>Generate a 45-minute, NGSS-aligned lab activity for one or more biology lessons.</CardDescription>
                        </div>
                      </div>
                    </CardHeader>
