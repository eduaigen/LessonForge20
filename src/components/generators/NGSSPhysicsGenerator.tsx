...
import { Loader2, Magnet, Sparkles, Wand2 } from 'lucide-react';
...
const GeneratorContent = () => {
  ...
  const topics = useMemo(() => {
    ...
    const unitData = physicsCurriculum.units[selectedUnit as keyof typeof physicsCurriculum.units];
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              render={({ field }) => (
                                  ...
                                  <Select onValueChange={(value) => {
                                      ...
                                      <SelectContent>
                                      {topics.map((topicKey) => {
                                        const unit = physicsCurriculum.units[selectedUnit as keyof typeof physicsCurriculum.units];
