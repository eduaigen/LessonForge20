...
import { generateAlgebra2Test } from '@/ai/flows/generate-algebra2-test';
...
const GeneratorContent = () => {
  ...
  async function onSubmit(values: FormData) {
    ...
    setTestPackage(null);
    try {
      const result = await generateAlgebra2Test(values);
              ...
              <Card className="w-full shadow-lg mb-8">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className="text-2xl font-headline">Algebra 2 Test Generator</CardTitle>
                      <CardDescription>Create a custom, Regents-style test for Algebra 2.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
...
export default function Algebra2TestGenerator() {
