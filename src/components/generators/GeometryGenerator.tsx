...
import { generateGeometryLesson, type GenerateGeometryLessonOutput } from '@/ai/flows/generate-geometry-lesson';
    ...
    <div className="flex flex-1 items-center justify-center">
        <Card className="max-w-2xl text-center p-8 shadow-lg">
            <CardHeader>
                ...
                <CardDescription>
                    The Geometry Generator requires a Math curriculum subscription. Subscribe now to create powerful, standards-aligned 5E lesson plans.
                </CardDescription>
            </CardHeader>
            <CardContent>
...
const GeneratorContent = () => {
  ...
  async function onLessonPlanSubmit(values: FormData) {
    ...
    try {
      const result = await generateGeometryLesson(values);
                  ...
                  <CardHeader>
                      <div className="flex items-center justify-between flex-wrap gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                              <CardTitle className="text-2xl font-headline">Illustrative Math - Geometry Lesson Generator</CardTitle>
                        ...
                        <Accordion type="single" collapsible className="w-full" defaultValue='item-1'>
                          ...
                          <FormField
                              ...
                              render={({ field }) => (
                                  ...
                                  <FormControl>
                                      <Textarea placeholder="e.g., 'Focus on formal proofs', 'Connect to architecture', 'Emphasize use of dynamic geometry software'" {...field} />
                                  </FormControl>
                                  <FormMessage />
                                  </FormItem>
                              )}
...
export default function GeometryGenerator() {
